...
function university_files() {
  wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyASVnfcZkTPi7gNkOySneUKO1RmlnU1SGU', NULL, '1.0', true);
...
function universityMapKey($api) {
  $api['key'] = 'AIzaSyASVnfcZkTPi7gNkOySneUKO1RmlnU1SGU';
  return $api;
}
